...
// Clients — populated from Supabase leads table only. No fake data.
const mockClients: Client[] = [];

const mockNiches: string[] = [];

const mockCompetitors: CompetitorData[] = [];

const mockAudience = {
  ageRange: 'Configure API keys to enable AI research',
  interests: [] as string[],
  income: 'Waiting for research...',
  platform: 'Waiting for research...',
};

const mockContentThemes: string[] = [];

const mockAutomationPipeline = [
  { step: 'Research', type: 'AI', completed: false },
  { step: 'Script', type: 'AI', completed: false },
  { step: 'Edit', type: 'Manual', completed: false },
    ...
    <div className="bg-lumina-card border border-lumina-border rounded-lg p-6">
      ...
      <div className="space-y-6">
        ...
        <button
          ...
          title="Configure API keys to enable AI research"
        >
          {isResearching && (
            <>
          ...
          {!isResearching && !researchComplete && (
            <>
              ...
              Configure API Keys to Enable AI Research
            </>
          )}
          {researchComplete && (
            <>
        ...
        <div>
          ...
          {mockClients.length === 0 ? (
            <div className="bg-lumina-card border border-lumina-border rounded-lg p-12 text-center">
              <Briefcase className="w-12 h-12 text-lumina-muted mx-auto mb-4" />
              <h3 className="text-xl font-bold text-lumina-text mb-2">No Clients Added Yet</h3>
              <p className="text-lumina-muted mb-4">
                Add clients to the leads table in Supabase to start managing your customer acquisition pipeline.
              </p>
              <p className="text-sm text-lumina-dim">
                Clients will appear here as you add them and move them through the sales funnel stages.
              </p>
            </div>
          ) : (
