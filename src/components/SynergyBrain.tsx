...
// Kill recommendations â populated by real Synergy Brain analysis only

const KILL_RECOMMENDATIONS: { jobId: string; jobName: string; reason: string; monthlyLoss: number; redirectTo: string }[] = []



export default function SynergyBrain() {

  // ââ LIVE from Supabase ââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  if (loading) {
    ...
    return (
      ...
      <div className="flex items-center gap-2 text-lumina-dim py-10">
        ...
        <span className="text-sm">Loading synergy dataâ¦</span>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-lumina-dim text-sm">Synergy detection Â· auto-kill Â· risk radar</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                return (
                  ...
                  <div key={s.id} className={clsx(
                    ...
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-lumina-pulse text-xs">â</span>
        ...
        {/* Risk radar â from live job risk scores */}
            ...
            <div key={rec.jobId} className="p-4 bg-lumina-danger/5 border border-lumina-danger/20 rounded-xl">
              ...
              <div className="flex items-start justify-between gap-2 mb-2">
                ...
                <div className="flex gap-2 flex-shrink-0">
                  ...
                  <button className="btn-ghost text-xs py-1.5 px-3 flex items-center gap-1" onClick={() => alert(`Ignored kill recommendation for ${rec.jobName}`)}>

                    <CheckCircle size={11} /> Ignore

                  </button>

                  <button className="text-xs py-1.5 px-3 rounded-lg bg-lumina-danger/20 text-lumina-danger border border-lumina-danger/30 hover:bg-lumina-danger/30 transition-colors flex items-center gap-1" onClick={() => alert(`Kill & Redirect: ${rec.jobName} â ${rec.redirectTo}. Connect to job orchestrator to execute.`)}>
              ...
              <div className="flex gap-4 text-xs text-lumina-dim">
                ...
                <span>â Redirect to: <span className="text-lumina-pulse">{rec.redirectTo}</span></span>
            ...
            return [(
              ...
              <div key={`${jobA.id}-${jobB.id}`} className="p-3 bg-lumina-bg/60 rounded-lg hover:bg-lumina-bg transition-colors">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <button className="text-xs bg-lumina-pulse/20 text-lumina-pulse px-2 py-0.5 rounded-full hover:bg-lumina-pulse/30 transition-colors" onClick={() => alert(`Synergy activated: ${jobA.name} Ã ${jobB.name}. Cross-job pipeline will run on next cycle.`)}>
