 ...
 * PuLP tax routing Â· auto-categorize Â· quarterly set-aside Â· Tax Pot
...
// PuLP deduction allocations â empty until real tax data is entered
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-lumina-dim text-sm">PuLP auto-routing Â· computed from live income Â· quarterly vault</p>

        </div>

        <div className="flex gap-2">

          <button className="btn-ghost flex items-center gap-2 text-sm" onClick={() => alert('Export CPA: Tax summary report will be generated as CSV. Connect to your CPA portal for direct upload.')}>
      ...
      <div className="card-glow">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-xs text-lumina-dim">
            ...
            Â· Available: <span className="text-lumina-warning font-mono">${moreSavings.toLocaleString()}</span>
            ...
            <div key={a.category} className={clsx(
              ...
              <div className="flex items-center gap-2">
                ...
                {!a.applied && (
                  ...
                  <button className="badge-gold badge text-[10px] cursor-pointer hover:opacity-80" onClick={() => alert(`Tax deduction applied: ${a.category} â saving $${a.savings.toLocaleString()}. This will be reflected in your quarterly forecast.`)}>Apply</button>
