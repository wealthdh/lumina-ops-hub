/**
 * All Supabase data hooks â single source of truth.
...
// âââ Auth / current user ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export function useTodayBriefing(): { data: DailyBriefing | null | undefined; isLoading: boolean } {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async (): Promise<DailyBriefing | null> => {
      ...
      if (!data) return null  // React Query v5 disallows undefined â must return null
...
// âââ Tax Pot ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Tax Entries ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Synergy Links ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Allocation Rules (PuLP output) ââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Monte Carlo Results ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Arbitrage Signals ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export function useArbitrageSignals() {
  ...
  // Realtime subscription â instant updates when Edge Harmonizer pushes new signals
  useEffect(() => {
    const ch = supabase
      .channel(`arbitrage_signals_live_${Date.now()}`)
      .on('postgres_changes', {
        event: 'INSERT',
        schema: 'public',
...
// âââ Polymarket Markets (cached in Supabase) ââââââââââââââââââââââââââââââââââ
...
// âââ Polymarket Positions âââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Jobs (re-export from useJobs for convenience) ââââââââââââââââââââââââââââ
