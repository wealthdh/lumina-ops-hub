/**
 * Vercel Serverless Function â Kling AI Video Generation Proxy
 *
 ...
 *   POST ?action=text2video   â Create a text-to-video generation task
 *   POST ?action=image2video  â Create an image-to-video generation task
 *   GET  ?action=status&task_id=xxx â Poll task status
 */
import crypto from 'crypto';
import { createClient } from '@supabase/supabase-js';

// âââ JWT Generation ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function generateKlingJWT() {
  ...
  // Payload â 30 min expiry, valid from 5s ago
  const payload = {
    iss: accessKey,
    exp: now + 1800,
    nbf: now - 5,
...
// âââ Kling API base ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const KLING_BASE = process.env.KLING_API_BASE || 'https://api.klingai.com';

// âââ Supabase client (initialized on demand) âââââââââââââââââââââââââââââââââ
...
// âââ Logger (with [KLING] prefix for consistency) ââââââââââââââââââââââââââ
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ââ Text-to-Video ââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Image-to-Video âââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Poll Task Status âââââââââââââââââââââââââââââââââââââââââââ
